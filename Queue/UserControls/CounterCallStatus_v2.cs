...
namespace Queue
{
    public partial class CounterCallStatus_v2 : UserControl
    {
        /*******************************************************************************************************/
        #region SETTINGS
        ...
        public CounterCallStatus_v2(): this(null, null) { }
        public CounterCallStatus_v2(string counterName, Guid? CounterAddresses_Id)
        {
            InitializeComponent();
